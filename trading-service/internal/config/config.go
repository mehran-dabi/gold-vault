...
type APIConfig struct {
	WalletService WalletService `mapstructure:"wallet-service"`
	AssetService  AssetService  `mapstructure:"asset-service"`
}

// WalletService holds wallet service configuration
...
// AssetService holds asset service configuration
